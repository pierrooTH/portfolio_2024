        ...
        <Section className="flex max-lg:flex-col  items-center gap-4">
            <div className="flex-[3] w-full">
                <div className="w-full flex flex-col gap-2">
                    ...
                    <h3 className="font-caption text-2xl">Développeur full-stack, passionné par l&apos;informatique et le web 🚀</h3>
                    <p className="leading-8 text-sm">Fort de plus de <Code>trois ans</Code> d&apos;expérience en <Code>développement web</Code>, je suis à la recherche de nouvelles <Code>opportunités</Code> pour enrichir mon parcours. Basé près de <Code className="inline-flex items-center gap-1">
            ...
            <div className="flex-[2] w-full flex flex-col gap-4 items-center">
